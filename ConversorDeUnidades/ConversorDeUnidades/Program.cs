        ...
        static void Potencia()
        {
            ...
            switch(op)
            {
                ...
                case 3:
                    ...
                    decimal1 = Convert.ToInt32(binario, 2);
                    Console.WriteLine($"---\n{binario} en Binario es {decimal1} en Decimal.\n---");
                    Console.WriteLine("Gracias...");
                    Console.WriteLine("ENTER para continuar");
                    Console.ReadLine();
                    Console.Clear();
                ...
                case 4:
                    ...
                    decimal1 = Convert.ToInt32(binario, 2);
                    result = Convert.ToString(decimal1, 8);
                    Console.WriteLine($"---\n{binario} en Binario es {result} en Octal.\n---");
                    Console.WriteLine("Gracias...");
                    Console.WriteLine("ENTER para continuar");
                    Console.ReadLine();
                    Console.Clear();
                ...
                case 5:
                    ...
                    decimal1 = Convert.ToInt32(octal, 8);
                    Console.WriteLine($"---\n{octal} en Octal es {decimal1} en Decimal.\n---");
                    Console.WriteLine("Gracias...");
                    Console.WriteLine("ENTER para continuar");
                    Console.ReadLine();
                    Console.Clear();
                ...
                case 6:
                    ...
                    decimal1 = Convert.ToInt32(octal, 8);
                    result = Convert.ToString(decimal1, 2);
                    Console.WriteLine($"---\n{octal} en Octal es {result} en Binario.\n---");
                    Console.WriteLine("Gracias...");
                    Console.WriteLine("ENTER para continuar");
                    Console.ReadLine();
                    Console.Clear();
